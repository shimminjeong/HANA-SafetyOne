...
<!-- Facebook Pixel Code -->
<noscript>
    <img alt="Facebook Pixel Code 이미지" height="1" width="1" src="https://www.facebook.com/tr?id=2808577885918545&ev=PageView&noscript=1" />
</noscript>
<!-- End Facebook Pixel Code -->
<!-- Google Tag Manager (noscript) -->
<noscript>
    <iframe title="Google Tag Manager" src="https://www.googletagmanager.com/ns.html?id=GTM-W5TBQX4" height="0" width="0" style="display:none;visibility:hidden"></iframe>
</noscript>
        ...
        <div class="content">
            ...
            <div class="contArea">
                <div class="inner">
                    <ul class="tabType01">
                        ...
                        <li data-title="Menu > 버거" data-desc="버거메뉴">
                            <a href="javascript:gotoMenu(1);" role="button" class='on' data-tab='단품메뉴'>
                                <span class='hide'>선택됨</span>
                                단품메뉴
                            </a>
                        </li>
                        <li>
                            <a href="javascript:gotoMenu(2);" role="button" >
                    ...
                    <div class="mcMenu">
                        ...
                        <div class="btnMore" id="btnMore">
                            <button type="button" class="more" onclick="more()">버거 메뉴 더보기</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                function addList(data){
                    if (blindArray.indexOf(data.pc_list_kor_alt) > -1){
                        return makeHtml("menu_on_blind",data);
                    }
                    return makeHtml("menu_off_blind",data);
                }
                function more(){
                    getList(init_page+1);
                }
            ...
            <script id="menu_on_blind" type="text/templet">
<li>
	<a href="javascript:goDetail({seq})" data-seq="{seq}">
		<div class="thum"><img src="{pc_list_image_url}" aria-hidden="true" alt=""></div>
		<div class="name">
			<span class="blind">{pc_list_kor_alt}</span>
			<strong class="ko">{kor_name}</strong>
			<em class="en" lang="en">{eng_name}</em>
		</div>
	</a>
</li>
</script>
            <script id="menu_off_blind" type="text/templet">
<li>
	<a href="javascript:goDetail({seq})" data-seq="{seq}">
		<div class="thum"><img src="{pc_list_image_url}" aria-hidden="true" alt=""></div>
		<div class="name">
    ...
    <footer class="footer">
        ...
        <div class="footArea">
            ...
            <ul class="fSns">
                <li><a href="https://www.facebook.com/McDonaldsKorea" class="fb" target="_blank" title="새창 열림">맥도날드 페이스북</a>
                </li>
                <li><a href="https://www.instagram.com/mcdonalds_kr/" class="ig" target="_blank" title="새창 열림">맥도날드 인스타그램</a>
                </li>
                <li><a href="https://www.youtube.com/user/McDonaldsKor" class="yt" target="_blank" title="새창 열림">맥도날드 유투브</a>
                </li>
                <li><a href="https://story.kakao.com/ch/mcdonalds/feed" class="ks" target="_blank" title="새창 열림">맥도날드 카카오스토리</a>
                </li>
                <li class="web_accessibility">
                    <a href="http://kwacc.or.kr/CertificationSite/WA/1664/Detail?page=1" target="_blank" title="한국디지털접근성진흥원 인증결과">
                        <img src="/kor/images/common/web_accessibility.png" alt="과학기술정보통신부 Web 접근성 (사)한국시각장애인연합회 2023.5.2 ~ 2024.5.1">
                    </a>
                </li>
            </ul>
            <div class="fInfo">
