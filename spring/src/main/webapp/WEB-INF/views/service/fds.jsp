...
<div class="container">
    <div id="service">
        <div class="serviceTitle"><img src="../../../resources/img/bell.png"/><div>이상 거래 알림서비스</div></div>
        <div class="service-content2">
            ...
            <a href="/fds/fdsCardSelect">
                <button class="regBtn">신청/해제</button>
            </a>
        </div>
        <div class="service_wrap">
            <div class="h_wrap">이상 거래 알림서비스란?</div>
            <ul class="marker_dot">
                <li>이 서비스는 사용자의 일반적인 소비 패턴과 다른 의심스러운 거래를 즉시 감지하여 알림을 제공하는 서비스입니다. <br>
                    사용자의 카드 사용 패턴과 다른 업종, 지역, 시간대에서 발생하는 거래를 중심으로, 이상거래를 즉시 탐지하고 사용자에게 알려줍니다.
                </li>
