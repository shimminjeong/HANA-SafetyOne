    ...
    <div id="right-service">
        ...
        <div class="service-content1">
            <div class="text_div">
                ...
                <br>
                <div class="sub-txt">거래를 허용하거나 차단할 지역, 시간, 업종 등 나만의 Rule을 간편하게 설정</div>
                </p>
            </div>
            <a href="/safetyCard/safetyCardSelect">
                <button class="regBtn" style="background-color: #5699d4;">등록/해제</button>
            </a>
        </div>
        <div class="service_wrap">
            <div class="h_wrap">안심 서비스란?</div>
            <ul class="marker_dot">
